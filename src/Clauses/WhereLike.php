...
class WhereLike extends Clause
{
     ...
     * @var string
     */
    protected string $signature = 'where%1$sLike(string $value, bool $caseSensitive = false, string $boolean = \'and\', bool $not = false) Add a "where like" clause on the "%2$s" column to the query.';
}
